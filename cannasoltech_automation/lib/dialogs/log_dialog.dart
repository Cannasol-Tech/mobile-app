...
class _HistoryLogDialogState extends State<HistoryLogDialog>
    with AnimationMixin {
              ...
              child: Scrollbar(
                ...
                child: Markdown(
                  ...
                  styleSheet: MarkdownStyleSheet(
                    ...
                    p: const TextStyle(color: Colors.black, fontSize: 12.0),
      ...
      actions: [
        (ElevatedButton(
          ...
          child: DialogButtonText(
              dispText: 'Close', scalar: scalar.value, color: Colors.black45),
        ))
      ],
    );
  }
